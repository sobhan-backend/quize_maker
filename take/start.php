...
$stmt = $conn->prepare("SELECT id, option_text FROM options WHERE question_id = ? ORDER BY id");
...
<div class="container py-4">
    <div class="card-quiet question-card mx-auto" style="max-width: 800px;">
        <div class="card-body p-4 p-md-5">
            ...
            <p class="question-text fw-semibold mb-4"><?= nl2br(htmlspecialchars($question['question_text'])) ?></p>
